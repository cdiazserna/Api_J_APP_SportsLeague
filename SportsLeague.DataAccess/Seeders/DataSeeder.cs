    ...
    public static class DataSeeder
    {
        public static async Task SeedAsync(LeagueDbContext context)
        {
            ...
            var teams = new List<Team>
            {
                ...
                new() { Name="Deportivo Cali", City="Cali", Stadium="Deportivo Cali", FoundedDate=new DateTime(1912, 5, 23) },
                ...
                new() { Name="Once Caldas", City="Manizales", Stadium="Palogrande", FoundedDate=new DateTime(1961, 2, 15) },
                new() { Name="Deportivo Pasto", City="Pasto", Stadium="Departamental Libertad", FoundedDate=new DateTime(1949, 5, 12) },
                new() { Name="Deportivo Pereira", City="Pereira", Stadium="Hernán Ramírez Villegas", FoundedDate=new DateTime(1944, 11, 12) },
                new() { Name="Águilas Doradas", City="Rionegro", Stadium="Alberto Grisales", FoundedDate=new DateTime(2008, 1, 1) },
                new() { Name="Boyacá Chicó FC", City="Tunja", Stadium="La Independencia", FoundedDate=new DateTime(2002, 7, 20) },
                new() { Name="Jaguares de Córdoba", City="Montería", Stadium="Jaraguay", FoundedDate=new DateTime(2012, 7, 15) },
                new() { Name="Alianza Valledupar FC", City="Valledupar", Stadium="Armando Maestre", FoundedDate=new DateTime(2003, 8, 15) },
                new() { Name="Fortaleza FC", City="Bogotá", Stadium="Metropolitano de Techo", FoundedDate=new DateTime(2019, 1, 1) },
                new() { Name="Llaneros FC", City="Villavicencio", Stadium="Bello Horizonte", FoundedDate=new DateTime(2018, 1, 1) },
                new() { Name="Cúcuta Deportivo", City="Cúcuta", Stadium="General Santander", FoundedDate=new DateTime(1924, 1, 1) },
